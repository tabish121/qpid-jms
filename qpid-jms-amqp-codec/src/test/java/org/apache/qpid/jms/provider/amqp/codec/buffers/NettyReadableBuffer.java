 ...
 */
package org.apache.qpid.jms.provider.amqp.codec.buffers;
...
/**
 * Readable Buffer implementation based on a Netty ByteBuf
 */
public class NettyReadableBuffer implements ReadableBuffer {
    ...
    public ReadableBuffer flip() {
        return new NettyReadableBuffer(buffer.duplicate().setIndex(0, buffer.readerIndex()));
    }
