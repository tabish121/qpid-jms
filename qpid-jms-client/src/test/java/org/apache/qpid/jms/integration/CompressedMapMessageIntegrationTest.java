...
public class CompressedMapMessageIntegrationTest extends CompressedMessageTestCase {
    ...
    public void testSendCompressedMessageWithContent() throws Exception {
       final String compressionConfig = "?jms.compressionPolicy.compressAll=true";
        ...
        try (TestAmqpPeer testPeer = new TestAmqpPeer();) {
            ...
            testPeer.expectTransfer(messageMatcher, COMPRESSED_MAP_MESSAGE_FORMAT);
    ...
    public void testReceiveCompressedMessageWithContent() throws Exception {
        try (TestAmqpPeer testPeer = new TestAmqpPeer();) {
            ...
            testPeer.expectLinkFlowRespondWithTransfer(null, msgAnnotations, properties, null, dataContent, false, COMPRESSED_MAP_MESSAGE_FORMAT);
    ...
    private void doTestReceiveMinimalistCompressedMessage(Binary payload, Map<String, Binary> expected) throws Exception {
        try (TestAmqpPeer testPeer = new TestAmqpPeer();) {
            ...
            testPeer.expectReceiverAttach(notNullValue(), notNullValue(), null, null, offeredCapabilitiesMatcher, desiredCapabilities);
            testPeer.expectLinkFlowRespondWithTransfer(null, null, null, null, dataContent, false, COMPRESSED_MAP_MESSAGE_FORMAT);
            testPeer.expectDispositionThatIsAcceptedAndSettled();
