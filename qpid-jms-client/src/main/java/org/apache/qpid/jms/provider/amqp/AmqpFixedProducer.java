...
public class AmqpFixedProducer extends AmqpProducer {
    ...
    private void doSend(JmsOutboundMessageDispatch envelope, InFlightSend send) throws ProviderException {
        ...
        getEndpoint().sendNoCopy(new AmqpReadableBuffer(encoded.copy(true))); // TODO: Copy is not strictly needed
        // Need to write but restore buffer position if send fails.
