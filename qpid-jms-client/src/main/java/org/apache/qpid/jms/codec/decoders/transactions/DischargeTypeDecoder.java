...
public class DischargeTypeDecoder implements DescribedTypeDecoder<Discharge>, ListEntryHandler<Discharge> {
    ...
    @Override
    public Discharge readValue(ByteBuf buffer, DecoderState state) throws IOException {
    ...
    @Override
    public void onListEntry(int index, Discharge discharge, ByteBuf buffer, DecoderState state) throws IOException {
        switch (index) {
            case 0:
