 ...
 */
public class ReleasedTypeDecoder implements DescribedTypeDecoder<Released> {
    ...
    @Override
    public Released readValue(ByteBuf buffer, DecoderState state) throws IOException {
