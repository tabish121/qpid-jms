 ...
 */
public class AcceptedTypeEncoder implements DescribedListTypeEncoder<Accepted> {
    ...
    @Override
    public void writeElement(Accepted source, int index, ByteBuf buffer, EncoderState state) {
    }
