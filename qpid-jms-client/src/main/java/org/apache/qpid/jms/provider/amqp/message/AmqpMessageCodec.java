...
public abstract class AmqpMessageCodec {
    ...
    /**
     * Using the source JMS message return the proper AMQP message format for the transfer.
     *
     * @param message the message that will be encoded and sent as an AMQP message
     *
     * @return the message format that should be assigned to the AMQP transfer.
     */
    public abstract int getMessageFormat(JmsMessageFacade message);
     ...
     */
    public abstract AmqpJmsMessageFacade decodeMessage(AmqpConsumer consumer, ReadableBuffer messageBytes, int messageFormat) throws IOException;
