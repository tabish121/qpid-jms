...
public interface TracableMessage {
    ...
    /**
     * Allows the tracing layer to filter out tracing related annotations from the full
     * set of annotations that a message might be carrying.
     *
     * @param filter
     * 		The filter function that will be used to extract tracing related annotations.
     */
