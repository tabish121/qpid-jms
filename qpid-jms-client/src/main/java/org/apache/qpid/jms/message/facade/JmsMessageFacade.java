 ...
 */
public interface JmsMessageFacade extends TracableMessage {
    ...
    /**
     * Called before a message is delivered to client code to allow for any necessary
     * processing of message data.
     *
     * @throws JMSException if an error occurs while preparing the message for delivery.
     */
    void onDelivery() throws JMSException;
